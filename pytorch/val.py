...
network.eval()
with open(os.path.join('./data/train_suncg_fur.list')) as file:
    model_list = [line.strip().replace('/', '/') for line in file]

partial_dir = "/media/wangyida/HDD/database/SUNCG_Yida/train/pcd_partial_fur/"
# partial_dir = "/home/wangyida/Documents/gitfarm/forknet/results_pcds/"
gt_dir = "/media/wangyida/HDD/database/SUNCG_Yida/train/pcd_complete_fur/"
